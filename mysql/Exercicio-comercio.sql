...
/*Update dados, corrigindo as mulheres que estao com o sexo como masculino*/
UPDATE cliente c set sexo = "F" where c.IDCLIENTE in(11,12,16,17);
...
select c.SEXO,count(*) as Quantidade from cliente C GROUP BY c.sexo;

/* IDs e E-mails das mulheres que morem no centro do rio de janeiro e nao tenha celular */
select c.IDCLIENTE, c.EMAIL
from cliente c
inner join endereco e
on c.IDCLIENTE = e.IDENDERECO
inner join telefone t
on c.IDCLIENTE = t.IDTELEFONE
where c.SEXO="F" 
and e.BAIRRO="CENTRO" 
